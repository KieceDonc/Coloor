...
public class AddFromHex extends Dialog implements View.OnClickListener {
    ...
    public AddFromHex(@NonNull Activity activity) {
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_add_from_hex);
