...
public class DownloadFile extends Dialog implements android.view.View.OnClickListener {
    ...
    public DownloadFile(@NonNull Context context, @NonNull Activity activity, setOnListener listener) {
        super(context);
