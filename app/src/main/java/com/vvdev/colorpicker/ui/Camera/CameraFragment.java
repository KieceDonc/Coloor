...
import static com.vvdev.colorpicker.activity.MainActivity.CallColorUtils;
...
public class CameraFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * Value of front camera for mCameraID
     */
    public static final String CAMERA_FRONT = "1";

    /**
     * Value of back camera for mCameraID
     */
    ...
    /**
     * TextView in camera top who's displaying the name of color
     */
    private TextView TVColorName;

    /**
     *  TextView in camera top who's displaying the hex value of color
     */
    private TextView TVHexValue;

    /**
     *  TextView in camera top who's displaying the RGB value of color
     */
    private TextView TVRGBValue;

    /**
     *  TextView in camera top who's displaying the hsv value of color
     */
    private TextView TVHsvValue;
     ...
     */
    private Runnable RunnableCameraTop;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        TVHsvValue = view.findViewById(R.id.HsvValue);
    ...
    public void onResume() {
        ...
        HandlerCameraTop.postDelayed( RunnableCameraTop = new Runnable() {
            @Override
            public void run() {
                CameraTopRefresh();
                HandlerCameraTop.postDelayed(RunnableCameraTop,DelayCameraTop);
            }
        },DelayCameraTop);
    ...
    /**
     * Local variable of CameraTopRefresh but call here to don't recall getActivity().getResources() every time we refresh camera_top.xml
     */
    private String SHex,SHsv,SRGB;
    ...
    public void CameraTopRefresh() {
        int[] RGBAverage = CallColorUtils.getRGBAverage(mTextureView, CameraCircle);
        String ToDisplayRGB = SRGB+" "+RGBAverage[0]+", "+RGBAverage[1]+", "+RGBAverage[2];
        TVRGBValue.setText(ToDisplayRGB);

        String HexValue = CallColorUtils.getHexFromRGB(RGBAverage);
        String ToDisplayHex = SHex+" "+HexValue;
        TVHexValue.setText(ToDisplayHex);

        String[] NearestColor = CallColorUtils.NearestColor(HexValue);
        TVColorName.setText(NearestColor[0]);

        int[] Hsv = CallColorUtils.getHsvFromRGB(RGBAverage);
    ...
    /**
     * Function that switch front and back camera
     */
    private void switchCamera() {
        if (mCameraId.equals(CAMERA_FRONT)) {
            Log.e("test",mCameraId);
