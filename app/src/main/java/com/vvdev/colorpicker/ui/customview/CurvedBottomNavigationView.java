package com.vvdev.colorpicker.ui.customview;
...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    // https://github.com/IslamBesto/CustomBottoBar/blob/java/app/src/main/java/com/example/saidi/custombottobar/view/CurvedBottomNavigationView.java

    private Path mPath;
    private Paint mPaint;

    /** the CURVE_CIRCLE_RADIUS represent the radius of the fab button */
    private final int CURVE_CIRCLE_RADIUS = 144 / 2;
